...
import { BcryptCompareAdapterInterface, JwtAdapterInterface, AuthenticationService, Login } from '@/domain/protocols/auth'
...
export class LoginController implements Login {
    constructor(
        ...
        readonly bcryptAdapter: BcryptCompareAdapterInterface,
